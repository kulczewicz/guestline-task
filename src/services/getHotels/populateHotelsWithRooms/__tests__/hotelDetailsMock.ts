export const serialisedHotelMock1 = {
  id: "OBMNG1",
  name: "DBM Hotel 1",
...
export const serialisedHotelMock2 = {
  id: "OBMNG2",
  name: "DBM Hotel 2",
...
export const hotelDetailsMock = {
  ...
  ratePlans: [
    ...
    {
      id: "BB_SAVER",
      shortDescription: "Bed and Breakfast - Payment Type First Night Charge!",
      longDescription: "BB_SAVER - Pre Payment Type",
      prePayment: "Deposit",
      cancellationPolicy: {
        name: "Strict",
        text: "There will be no refund. Do not pass go. Do not collect £200. KK",
        penalty: "Fixed",
        applicable: "Full Stay",
        amount: 100,
        days: 3,
    ...
    {
      id: "ROLLTEST",
      shortDescription: "ROLLTEST",
      longDescription: "Rolling Allowance Test",
      prePayment: "Reserve",
      cancellationPolicy: {
        name: "Free Cancelation",
        text: "You can cancel when ever you like.",
    ...
    },
    {
      ...
      longDescription:
        "BAR_DBB. Payment Type: Deposit 50%\r\nSome newly added description",
      prePayment: "Reserve",
      cancellationPolicy: {
        name: "Strict",
        text: "There will be no refund. Do not pass go. Do not collect £200. KK",
